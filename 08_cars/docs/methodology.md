...
**Second-wave additions (22 dealers):**
- **Rebrand (1):** Group 1 Ford of Kennesaw, formerly Jim Tidwell Ford.
- **Relocation within the study area (1):** Marietta Toyota, 30062 to 30060. (This later required excluding 30062 from Q4 weighting; see sec. 13.)
- **Market entries (20):** confirmed as having no 2020 record by checking both dealer name (`sp_name`) and brand (`franchise_make`) independently. Examples include Kia of Alpharetta, Jim Ellis Cadillac, and Porsche Atlanta Northwest/Northeast. Local market knowledge was essential here; no query alone could separate a new entrant from an existing dealer under an unrelated name.

`franchise_overrides` now holds 33 dealers. `final_matched` grew from 2,593 rows to 3,279 rows, with `COUNT(*) = COUNT(DISTINCT vin)` verified.
...
| September 2026 | 3.07 years |
| Difference | +4.97 months |
...
- **NULL mileage, 2026:** 37 rows (about 1.1%), no zip above about 3.3% (30096, 14 of 418).
...
| September 2026 | 45,962 miles |
| Difference | +4,368 miles |

Threshold: +15,000 miles (pre-registered). **Not met.**

**Cross-check with Q4:** 4,368 additional miles over about 0.41 additional years of age is roughly 10,500 miles per year, close to typical annual driving. The mileage increase is about what the age increase alone would produce. Inventory is older, not driven harder.# Metro Atlanta Used-Car Inventory Study: Methodology Log
...
**Cross-check with Q4:** 4,368 additional miles over about 0.41 additional years of age is roughly 10,500 miles per year, close to typical annual driving. The mileage increase is about what the age increase alone would produce. Inventory is older, not driven harder.