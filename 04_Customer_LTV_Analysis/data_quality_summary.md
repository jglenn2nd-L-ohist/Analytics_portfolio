...
| Quantity & UnitPrice negative values | Medium | Impact is considerable - The negative quantities will corrupt the analysis | Dropping along with the Cancelled orders, any outstanding negatives will be explicitly dropped |
